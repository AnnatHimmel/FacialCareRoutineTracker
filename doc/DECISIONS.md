...
**Affects Files**: `scripts/sync_from_supabase.dart` (per-key merge), `.claude/skills/release-prep/SKILL.md` (Phase 0 sync + drift guard), `assets/data/master_products.json` (regenerated), `lib/data/cache/shared_prefs_master_content_cache.dart`, `lib/domain/services/routine_scheduler.dart`, `lib/shared/providers/root_providers.dart`, `lib/app.dart`, `lib/features/setup/order_customization_screen.dart`, `test/data/cache/shared_prefs_master_content_cache_test.dart`, `test/domain/services/routine_scheduler_test.dart`, `test/features/setup/order_customization_screen_test.dart`, `doc/ARCHITECTURE.md`, `doc/DECISIONS.md`.
...
**Affects Files**: `lib/domain/services/routine_scheduler.dart`, `lib/shared/providers/root_providers.dart`, `lib/features/setup/order_customization_screen.dart`, `lib/features/home/daily_home_screen.dart` (reverted), `lib/shared/widgets/manual_order_sheet.dart`, `lib/shared/widgets/manual_order_chip.dart`, `test/domain/services/routine_scheduler_test.dart`, `doc/ARCHITECTURE.md`, `doc/FUNCTIONALITY.md`, `doc/UI_DESIGN.md`.
...
**Affects Files**: `lib/domain/services/routine_scheduler.dart`, `lib/shared/providers/root_providers.dart`, `lib/shared/widgets/manual_order_chip.dart` (new), `lib/shared/widgets/manual_order_sheet.dart` (new), `lib/features/home/daily_home_screen.dart`, `lib/core/l10n/app_en.arb`, `lib/core/l10n/app_he.arb` (+ generated), `test/domain/services/routine_scheduler_test.dart`, `test/shared/widgets/manual_order_chip_test.dart` (new), `doc/ARCHITECTURE.md`, `doc/FUNCTIONALITY.md`, `doc/UI_DESIGN.md`.
